...
//   process.exit(1);
// }
// // Cloudinary is optional in local dev; we'll disable the upload route if missing
...
//         user,
//         userId: userId || null,
//         message: message || "", // Can be empty if file exists
...
// ✅ FIXED CORS Configuration - Added port 4173
app.use(cors({
  origin: [
    "https://chatforge-frontend-fxkd.vercel.app",
    "http://localhost:5173",  // Vite dev mode
    "http://localhost:4173",  // Vite preview mode (ADDED THIS)
    "http://localhost:5000"
  ],
  credentials: true,
  methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
...
const io = new Server(server, {
  cors: {
    origin: [
      "https://chatforge-frontend-fxkd.vercel.app",
      "http://localhost:5173",
      "http://localhost:4173"  // ADDED THIS for Socket.IO too
    ],
    credentials: true
  }
});
